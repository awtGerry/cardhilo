...
img_path = os.path.dirname(os.path.abspath(__file__)) + '/isolated/'

# Image dimensions
IM_WIDTH = 1280
IM_HEIGHT = 720

# Dimensions for isolated rank and suit images
RANK_WIDTH = 70
RANK_HEIGHT = 125
SUIT_WIDTH = 70
SUIT_HEIGHT = 100
...
# ESP32-CAM URL
ESP32_CAM_URL = "http://192.168.100.124/cam-hi.jpg"  # Change to your ESP32-CAM IP
